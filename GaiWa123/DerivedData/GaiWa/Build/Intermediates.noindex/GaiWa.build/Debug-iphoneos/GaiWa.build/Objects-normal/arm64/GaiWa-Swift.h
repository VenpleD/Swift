...
#ifndef GAIWA_SWIFT_H
#define GAIWA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="GaiWa",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC5GaiWa11AppDelegate")
...
SWIFT_CLASS("_TtC5GaiWa23GWHomeAddViewController")
@interface GWHomeAddViewController : UIViewController
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC5GaiWa13SceneDelegate")
...
SWIFT_CLASS("_TtC5GaiWa14ViewController")
